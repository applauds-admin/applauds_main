...
class Task(TimestampedModel):
    ...
    mode = models.IntegerField(
        "Mode", choices=MODE_CHOICE, default=MODE_VERIFY,
        null=False, blank=False, db_index=True,
    )
...
class TaskUser(TimestampedModel):
    ...
    verify_address = models.CharField("Verify Address", db_index=True, max_length=42, unique=False, null=True, blank=True)
    owned = models.BooleanField("Owned", default=False, null=False, blank=False)
    request_hash = models.CharField("Verified By Functions", max_length=64, null=True, blank=True)
